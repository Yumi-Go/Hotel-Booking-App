      ...
      <Stack sx={{ width: "90%", alignItems: 'center', bgcolor: '#dedede', margin: 0, padding: 0 }}>
        ...
        <Box sx={{ width: "95%", my: "20px", bgcolor: "white" }}>
          ...
          searchResult && searchResult.length > 0 ?
            ...
            : <div>{searchResult.length === 0 ? (defaultText ? "Hello!" : "Loading...") : "No hotel found"}</div>
            }
          </Grid>
        </Box>
      </Stack>
...
//   // harde coded sample data.. to test when monthly quota is reached.. Remove this later
...
//           `https://places.googleapis.com/v1/places/ChIJZcFL1TMFdkgRZcciwfX0gr0/photos/ATplDJamCOEUyV-MOLLeglqobz0jEfSvx2Syt_AdH6vjg3IOQMfip6GyFPbEkN5rYFOevB95ik0ASw2b26ecL_r-mYsQ4cPoWnIfXwu0Q8P5iy3tzqfHqljNcatyn4HpzO0pTDFFnqPTsXwT3YkKl92s8QF6IPBsBgLfiums/media?maxHeightPx=1000&maxWidthPx=1000&key=${process.env.REACT_APP_FIREBASE_API_KEY}`,
//           `https://places.googleapis.com/v1/places/ChIJZcFL1TMFdkgRZcciwfX0gr0/photos/ATplDJZJNEg4i-lUjHlmmZOQXQk24G2q_zahiTYCKCbivYwtUstJdG27MPd_tSRdc45CZaK0QR3hLSZbetK7yVcZn5Q3YKbaR8-rdW7G7h4_PDKmmLPkhb06KRRGyFIM_9QVxBCVvUg2tAI5D7Kg03uVEAsIsytRgd-URfD9/media?maxHeightPx=1000&maxWidthPx=1000&key=${process.env.REACT_APP_FIREBASE_API_KEY}`,
